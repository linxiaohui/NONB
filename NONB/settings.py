"""
Django settings for NONB project.
...
SECRET_KEY = 'django-insecure-8m_k%hwxzby9o@e5^lvc(aa-lf%y(d*a71278p98(f*a@#_9tx'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'note.context_processors.note_processor'
            ],
        },
    },
]

WSGI_APPLICATION = 'NONB.wsgi.application'
